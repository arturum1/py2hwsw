...
def instWires(type, asynch, be):
    if type == "SZ":
        if asynch:
            print("   wire clkA;")
            print("   assign clkA = wclk;")
            print("   wire clkB;")
            print("   assign clkB = rclk;")
        else:
            print("   wire clkA;")
            print("   assign clkA = clk;")
            print("   wire clkB;")
            print("   assign clkB = clk;")
        print("   wire [ADDR_W-1:0] addrA;")
        print("   assign addrA = w_addr;")
        print("   wire [ADDR_W-1:0] addrB;")
        print("   assign addrB = r_addr;")
        print("   wire [DATA_W-1:0] dinA;")
        print("   assign dinA = w_data;")
        print("   wire [DATA_W-1:0] dinB;")
        print("   assign dinB = {DATA_W{1'b0}};")
        print("   wire [DATA_W-1:0] doutA;")
        print("   wire [DATA_W-1:0] doutB;")
        if be:
            print("   wire [DATA_W/8-1:0] wenA;")
            print("   assign wenA = ~w_en;")
            print("   wire [DATA_W/8-1:0] wenB;")
            print("   assign wenB = {(DATA_W/8){1'b1}};")
        else:
            print("   wire wenA;")
            print("   assign wenA = ~w_en;")
            print("   wire wenB;")
            print("   assign wenB = 1'b1;")
        print("   wire enA;")
        print("   assign enA = w_en;")
        print("   wire enB;")
        print("   assign enB = r_en;")
        print("   wire oeA;")
        print("   assign oeA = 1'b1; //1'b0;")
        print("   wire oeB;")
        print("   assign oeB = 1'b1; //r_en;")
        print("   assign r_data = doutB;")
        if be:
            print("   wire [DATA_W/8-1:0] wen;")
            print("   assign wen = ~w_en;")
        else:
            print("   wire wen;")
            print("   assign wen = ~w_en;")
        print("   wire csnA;")
        print("   assign csnA = ~w_en;")
        print("   wire csnB;")
        print("   assign csnB = ~r_en;")
    elif type == "SJ":
        if not asynch:
            print("   wire clkA;")
            print("   assign clkA = clk;")
        ...
        if be:
            print("   wire [DATA_W/8-1:0] wenA;")
            print("   assign wenA = ~weA;")
            print("   wire [DATA_W/8-1:0] wenB;")
            print("   assign wenB = ~weB;")
        else:
            print("   wire wenA;")
            print("   assign wenA = ~weA;")
            print("   wire wenB;")
            print("   assign wenB = ~weB;")
        print("   wire oeA;")
        print("   assign oeA = 1'b1; //enA;")
        print("   wire oeB;")
        print("   assign oeB = 1'b1; //enB;")
    elif type == "SH":
        if be:
            print("   wire [DATA_W/8-1:0] wen;")
            print("   assign wen = ~we;")
            ...
            print("   assign wen = ~we;")
        print("   wire oe);")
        print("   assign oe = 1'b1; //en & ~(|we);")
    elif type == "SP":
        print("   wire oe;")
        print("   assign oe = 1'b1; //r_en;")
    print("")
    if type == "spregf":
        if asynch:
            print("   wire clkA;")
