...
# Constrain clock generated by PS7 (internal wire of fpga wrapper)
# Get the net name of the internal signal
#create_clock -period 20 -name clk_50 [get_pins iob_system_iob_smart_zynq_sl/clk]
