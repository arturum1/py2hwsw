...
# NOTE: The port names specified here are the external ports generated by the iob_smart_zynq_sl/board.tcl file (not the ports of iob_system_iob_zybo_z7.py module).
