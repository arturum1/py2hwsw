...
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} [get_ports led1_o]
set_property -dict {PACKAGE_PIN P21 IOSTANDARD LVCMOS33} [get_ports led2_o]
# set_property -dict {PACKAGE_PIN K21 IOSTANDARD LVCMOS33} [get_ports key1_i]
# set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS33} [get_ports key2_i]
...
# if { $USE_ETHERNET > 0 } {
# 	# RGMII PHY
# 	create_clock -period 8 -name RGMII_rxc [get_ports rgmii_rxc_i]
...
# 	set_property -dict {PACKAGE_PIN A21 IOSTANDARD LVCMOS33} [get_ports rgmii_rx_ctl_i]
# 	set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports rgmii_rxc_i]
...
# 	set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS33} [get_ports rgmii_tx_ctl_o]
# 	set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVCMOS33} [get_ports rgmii_txc_o]
...
# 	set_property SLEW FAST [get_ports rgmii_tx_ctl_o]
# 	set_property SLEW FAST [get_ports rgmii_txc_o]
# }
