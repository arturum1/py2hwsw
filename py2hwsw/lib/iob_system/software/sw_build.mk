...
iob_system_bootrom.hex: ../../software/iob_system_preboot.bin ../../software/iob_system_boot.bin
	../../scripts/makehex.py ../../software/iob_system_preboot.bin 0 ../../software/iob_system_boot.bin 00000080 $(call GET_IOB_SYSTEM_CONF_MACRO,BOOTROM_ADDR_W) $@

iob_system_firmware.hex: iob_system_firmware.bin
	../../scripts/makehex.py $< 0 $(call GET_IOB_SYSTEM_CONF_MACRO,MEM_ADDR_W) $@
	../../scripts/makehex.py --split $< 0 $(call GET_IOB_SYSTEM_CONF_MACRO,MEM_ADDR_W) $@
