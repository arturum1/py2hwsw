...
static void ConfigureSimpleVReadShallow(VReadConfig *inst, int numberItems,
                                        int *memory) {
  inst->enableRead = 1;
...
static void ConfigureSimpleVRead(VReadConfig *inst, int numberItems,
                                 int *memory) {
...
static void ConfigureSimpleVWriteShallow(VWriteConfig *inst, int numberItems,
                                         int *memory) {
  inst->enableWrite = 1;
...
static void ConfigureSimpleVWrite(VWriteConfig *inst, int numberItems,
                                  int *memory) {
...
static void ConfigureMemoryOutputAndStart(MemConfig *inst, int amountOfData,
                                          int start) {
...
static void ConfigureMemoryOutputAndLoad(MemConfig *inst, int amountOfData,
                                         int start, MemAddr addr, int *data) {
