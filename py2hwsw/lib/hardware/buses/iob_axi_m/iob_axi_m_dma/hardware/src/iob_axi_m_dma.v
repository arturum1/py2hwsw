...
module iob_axi_m_dma #(
   ...
   // Global signals
   `include "iob_axi_m_dma_iob_clk_s_port.vs"
   input rst_i,
   ...
   // AXI master interface
   `include "iob_axi_m_dma_axi_m_port.vs"
);
   ...
   iob_axi_m_read_dma #(
      ...
      .FIFO_ADDR_W(FIFO_ADDR_W)
       ...
       `include "iob_axi_m_dma_iob_clk_s_s_portmap.vs"
       .rst_i(rst_i),

       .r_addr_i           (r_addr_i),
       .r_length_i         (r_length_i),
       .r_start_transfer_i (r_start_transfer_i),
       .r_dma_req_en_i     (r_dma_req_en_i),
       .r_dma_req_i        (r_dma_req_i),
       .r_dma_req_pending_o(r_dma_req_pending_o),
       .r_dma_ack_o        (r_dma_ack_o),
   ...
   iob_axi_m_write_dma #(
      ...
      .FIFO_ADDR_W(FIFO_ADDR_W)
       ...
       .w_dma_req_en_i     (w_dma_req_en_i),
       .w_dma_req_i        (w_dma_req_i),
       .w_dma_req_pending_o(w_dma_req_pending_o),
       .w_dma_ack_o        (w_dma_ack_o),
       ...
       `include "iob_axi_m_write_dma_axi_write_m_m_portmap.vs"
   );
